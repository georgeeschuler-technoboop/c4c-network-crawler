...
Unified project config storage for LOCAL file management.

Config lives at: demo_data/{project_id}/config.json

This handles local project folders and config files.
NOT to be confused with c4c_project_store.py which handles cloud storage.
