...
VERSION HISTORY:
----------------
v4.1.0 (2026-01-06): Fixed package imports for proper module loading
- REMOVED: sys.path manipulation that broke relative imports
- CHANGED: Use absolute package imports (from insights.analyzers import ...)
- REQUIRES: insights/__init__.py must exist

v4.0.3 (2025-12-31): Fixed imports for Streamlit Cloud compatibility
...
# =============================================================================
# Package Imports (absolute imports — requires insights/__init__.py)
# =============================================================================

# Use absolute package imports. This requires:
# 1. insights/__init__.py exists (even if empty)
# 2. REPO_ROOT is in sys.path (app.py does this)
from insights.analyzers import (
    detect_network_type,
    detect_source_app,
    FunderAnalyzer,
    SocialAnalyzer,
...
ENGINE_VERSION = "4.1.0"  # Fixed package imports
BUNDLE_FORMAT_VERSION = "1.1"
RUN_PY_VERSION = "4.1.0"  # For debugging - check this value in logs
