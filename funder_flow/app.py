...
def main():
    ...
    # ==========================================================================
    current_project = st.session_state.get("current_project")
    stage2_status = "idle" if not current_project else ("complete" if st.session_state.get("processed") else "active")
    c4c_stage_open(
        2,
        "Data",
        status=stage2_status,
        subtitle="Upload IRS 990 filings (PDF/XML) for this project. Results and exports appear after processing."
    )
