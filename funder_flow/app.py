...
# Optional card wrapper for pipeline UI
if use_card:
    st.markdown('<div class="c4c-subcard">', unsafe_allow_html=True)
    st.markdown('<div class="c4c-subcard-hd"><span class="c4c-subcard-title">🗺️ Regional Perspective</span><span class="c4c-subcard-sub">Optional</span></div>', unsafe_allow_html=True)
