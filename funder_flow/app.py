...
# ============================================================================
# VERSION HISTORY (human-readable changelog)
# ============================================================================
VERSION_HISTORY = [
    "UPDATED v0.3.1: Versioning + seed upload cap restored",
    "- Seed upload now enforces max 10 rows",
    "- Clear separation of crawl types (people vs companies); no mixed seed CSVs",
    "- Crawl logs record KPIs appropriate to crawl type",
    "- Polinode-ready exports for company nodes (clean labels + key fields)",
]
# ============================================================================
